					...
					@foreach($bazars as $bazar)
						<tr>
							...
							<td>{{number_format($bazar->amount, 2)}}
								<button type="button" class="btn btn-secondary btn-xs example-popover" data-container="body" data-toggle="popover" data-placement="right" title="{{ json_decode($bazar->details) }}" data-content="{{ $bazar->details }}">
									Details
								</button>
							</td>
							<td>{{$bazar->date}}</td>
